...
# Use frozenset for O(1) membership check in _bind_value
...
# Pre-populate _TYPES with None for type(None) to avoid redundant get_type calls
_TYPES = {int:'n', float:'n', str:'s', bool:'b', type(None): None}

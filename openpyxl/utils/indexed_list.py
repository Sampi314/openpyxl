...
class IndexedList(list):
    ...
    def index(self, value):
        ...
        Performance optimization: use single lookup with try-except.
        """
        if not self.clean:
            self._rebuild_dict()
        try:
    ...
    def add(self, value):
        """
        Add a value to the list and return its index.
        Performance optimization: use .get() for single lookup.
        """
